...
class Inference(object):
    def __init__(self, args):
        ...
        print(f"load state_Dict:{args.resume}")
        self.deep_model.load_state_dict(checkpoint,strict=True)

        


    def test_result(self,if_visible):
...
def main():
    ...
    infer.test_result(if_visible=False)
